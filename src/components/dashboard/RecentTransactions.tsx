        ...
        <DialogContent>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 1 }}>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1.5 }}>
              <TextField
                label="Date" type="date" size="small" value={editDate}
                onChange={e => setEditDate(e.target.value)}
                InputLabelProps={{ shrink: true }} fullWidth
              />
              <TextField
                label="Time" type="time" size="small" value={editTime}
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1.5 }}>
              <TextField
                label="Paid By" select size="small" value={editPaidBy}
              ...
              <TextField
                label="Paid For" select size="small" value={editPaidFor}
